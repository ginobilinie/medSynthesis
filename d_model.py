...
'''
This class implements the DiscriminatorModel
...
class DiscriminatorModel:
    ...
    def build_feed_dict(self, input_frames, gt_output_frames, generator):
        ...
        for scale_num in xrange(self.num_scale_nets):
            ...
            #print 'g_scale_preds shape ',g_scale_preds[scale_num].shape
            #print 'scaled_gt_output_frames shape ',scaled_gt_output_frames[0].shape
            scaled_input_frames = np.concatenate([g_scale_preds[scale_num],
                                                  scaled_gt_output_frames])
            #print 'scaled_input_frames shape ',scaled_input_frames.shape
