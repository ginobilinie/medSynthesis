...
flags.DEFINE_integer("sizeCT", 16, "The size of CT patch [24]")
...
flags.DEFINE_string("path_patients_h5", "/home/dongnie/warehouse/prostate/MR_CT_32_16",
	 "Directory where the h5 files are located ['/home/dongnie/warehouse/prostate/MR_CT_32_16']")
FLAGS = flags.FLAGS
