# medSynthesis with TensorFlow (we also provide an improved version in pytorch with recent update, you can access it at https://github.com/ginobilinie/medSynthesisV1)
